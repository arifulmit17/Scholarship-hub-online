...
navigate('/')
  ...
  //       </div>
  <div className="max-w-md mx-auto p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-lg mt-10">
  ...
  <div className="mb-4">
    <button
      ...
      type="button"
      className="w-full flex items-center justify-center gap-3 border border-gray-300 dark:border-gray-600 p-3 rounded-lg text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition"
    >
